...
function OpenMobilespActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		elements = {
			...
			{label = _U('ems_clothes_civil'), value = 'citizen_wear'},
                        ...
                        {label = _U('ems_clothes_ems2'), value = 'ambulance2_wear'},
...
TriggerEvent("EMS:PriseDeService", false)
		...
		elseif data.current.value == 'ambulance2_wear' then
...
TriggerEvent("EMS:PriseDeService", false)
		...
		elseif data.current.value == 'bullet2_wear' then
		...
		elseif data.current.value == 'giletmed_wear' then
		...
		elseif data.current.value == 'bullet_wear' then
...
TriggerEvent("EMS:PriseDeService", false)
		...
		elseif data.current.value == 'feu_wear' then
