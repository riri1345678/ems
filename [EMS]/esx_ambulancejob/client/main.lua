...
function RemoveItemsAfterRPDeath()
	...
	Citizen.CreateThread(function()
		...
		ESX.ShowAdvancedNotification('REANIMATION X', 'Unité X réanimation', 'Vous avez été réanimé par l\'unité X.', 'CHAR_PEGASUS_DELIVERY', 1)
