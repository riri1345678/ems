...
AddEventHandler('AnnounceEMSOuvert', function()
	...
	for i=1, #xPlayers, 1 do
		...
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'EMS', '~b~Annonce Ambulancier', 'Un Ambulancier est en service ! Votre santé avant tout !', 'CHAR_CALL911 ', 8)
...
AddEventHandler('AnnounceEMSFerme', function()
	...
	for i=1, #xPlayers, 1 do
		...
		TriggerClientEvent('esx:showAdvancedNotification', xPlayers[i], 'EMS', '~b~Annonce Ambulancier', 'Il n\'y a plus de Ambulancier en service !', 'CHAR_CALL911 ', 8)
