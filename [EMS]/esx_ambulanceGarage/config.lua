...
Config.SPDatabaseName = 'ambulance'-- set the exact name from your jobs database for ambulance
...
Config.CarZones = {
	...
	SPCarGarage = {
		...
		Pos = {
			...
			{x = 293.62490844726, y = -577.766357, z = 43.19039},
...
Config.HeliZones = {
	...
	SPHeliGarage = {
		...
		Pos = {
			...
			{x =  299.62704467774,  y = -1453.260131836, z = 45.509128570556},

      			{x =  313.1531677246,  y = -1465.3168945312, z = 46.509128570556} 
...
Config.BoatZones = {
	...
	SPBoatGarage = {
		...
		Pos = {
			...
			{x = 1538.69,  y = 3901.5, z = 930.35},



			{x = 2000.42,  y = 4500, z = 933.437}
...
Config.CarGarageName = "Garage ambulance"
...
Config.SPCarMarker = 27 												-- marker type



Config.SPCarMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 			-- rgba color of the marker



Config.SPCarMarkerScale = { x = 1.5, y = 1.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
...
Config.SPHeliMarker = 27 												-- marker type



Config.SPHeliMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker



Config.SPHeliMarkerScale = { x = 5.5, y = 5.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
...
Config.SPBoatMarker = 27 												-- marker type



Config.SPBoatMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker



Config.SPBoatMarkerScale = { x = 3.0, y = 3.0, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
...
Config.SPExtraMarker = 27 												-- marker type



Config.SPExtraMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker



Config.SPExtraMarkerScale = { x = 2.5, y = 2.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
...
Config.SPVehicles = {
		...
		{ model = '', label = '-----Vehicules Service-----'},
               ...
               { model = 'dodgeems', label = 'Dodge EMS'},
...
Config.SPHelicopters = {



	{ model = 'supervolito2', label = 'Helicoptere Securité civile', livery = 0, price = 0 },
...
Config.TitleSPGarage = "ambulance Garage"



Config.TitleSPExtra = "Extra"



Config.TitleSPLivery = "Livery"
...
Config.CarOutFromPolGar = "Vous avez sorti un ~b~Vehicule~s~ du~y~ Garage~s~!"



Config.HeliOutFromPolGar = "You took out a ~b~Helicopter~s~ from ~y~ambulance Heli Garage~s~!"



Config.BoatOutFromPolGar = "You took out a ~b~Boat~s~ from ~y~ambulance Boat Garage~s~!"
